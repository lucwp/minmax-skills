...
### 4. Verify the change
**What happens:** run the independent verifier and compare against the baseline
**Why:** confirm material progress without weakening the criteria
**Produces:** PASS evidence or the next verifiable gap
**Then:** stop on PASS or continue within budget

### 5. Confirm terminal completion
**What happens:** run the full terminal verification
**Why:** prove that the deliverable satisfies the global objective
**Produces:** terminal result and final evidence
**Then:** synthesize the result and stop

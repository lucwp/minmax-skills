...
**O que acontece:** executar o verifier independente e comparar com o baseline
**Por quê:** confirmar progresso material sem enfraquecer os critérios
**Produz:** evidência de PASS ou próximo gap verificável
**Depois:** encerrar no PASS ou continuar dentro do orçamento

### 5. Confirmar a saída final
**O que acontece:** rodar a verificação terminal completa
**Por quê:** garantir que o entregável satisfaz o objetivo global
**Produz:** resultado terminal e evidências finais
**Depois:** sintetizar o resultado e encerrar
